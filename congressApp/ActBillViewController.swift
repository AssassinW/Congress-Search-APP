...
class ActBillViewController: UITableViewController ,UISearchResultsUpdating{
    ...
    override func viewDidLoad() {
        ...
        let url = "http://awesomeapp.i4a5jetas8.us-west-2.elasticbeanstalk.com/serv.php?search_field=actbills"
        ...
        if segue.identifier == "Detail" {
            if let indexPath = tableView.indexPathForSelectedRow {
                ...
                let action = tableData[indexPath.row]["last_action_at"]! as! String
                    //tableData[indexPath.row]["last_version"]!["urls"]["pdf"] as! String
                var pdf:String = ""
                ...
                //tableData[indexPath.row]["urls"]?["pdf"]! as! String
                ...
                //tableData[indexPath.row]["history"]?["active"]! as! String
